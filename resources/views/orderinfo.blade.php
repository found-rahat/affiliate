                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="note" type="text" class="form-control" id="note" required cols="30"
                                    placeholder="Some note" rows="2">{{ $customer->note }}</textarea>
                            </div>
                        </div>
                    </div>
                @endforeach
                    ...
                    <div class="row">
                        @foreach ($query as $product)
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $product->discount }} Taka"
                                    placeholder="Status">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Pre Payment</label>
                                <input type="nmber" class="form-control" value="{{ $product->pre_payment }} Taka"
                                    placeholder="Status">
                            </div>
